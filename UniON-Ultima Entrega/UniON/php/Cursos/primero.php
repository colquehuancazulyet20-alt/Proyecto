...
<body>
  ...
  <div class="banner-primero">
    <img src="../../img2/Cursos/Primero/curso1.png" alt="1er Grado" />
  </div>
    ...
    <div class="centro">
      <div class="bloque1">
        <section id="Cursos">
          <h2>Cursos</h2>
          <div class="grados">
            <a href="primero.php" class="grado">1er Grado</a>
            <a href="segundo.php" class="grado">2do Grado</a>
            <a href="tercero.php" class="grado">3ro Grado</a>
            <a href="cuarto.php" class="grado">4to Grado</a>
            <a href="quinto.php" class="grado">5to Grado</a>
            <a href="sexto.php" class="grado">6to Grado</a>
            <a href="septimo.php" class="grado">7mo Grado</a>
          </div>
      </div>
      </section>
    </div>
    ...
    <div class="Comunicados">
      <div class="bloque2">
        <section id="Foro">
          ...
          <?php
          $cursoID = 1; // este número identifica al curso 1er grado
          ?>
